...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Basic/f:extension">
      ...
      <sch:assert test="count(f:extension[@url = 'instance']) &gt;= 1">extension with URL = 'instance': minimum cardinality of 'extension' is 1</sch:assert>
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Basic/f:extension/f:extension">
      ...
      <sch:assert test="count(f:extension[@url = 'imageRegion2D']) &lt;= 0">extension with URL = 'imageRegion2D': maximum cardinality of 'extension' is 0</sch:assert>
      <sch:assert test="count(f:extension[@url = 'imageRegion3D']) &lt;= 0">extension with URL = 'imageRegion3D': maximum cardinality of 'extension' is 0</sch:assert>
