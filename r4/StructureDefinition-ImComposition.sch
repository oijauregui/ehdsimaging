...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Composition">
      <sch:assert test="count(f:extension[@url = 'http://hl7.eu/fhir/imaging-r4/StructureDefinition/im-composition-diagnosticReportReference']) &gt;= 1">extension with URL = 'http://hl7.eu/fhir/imaging-r4/StructureDefinition/im-composition-diagnosticReportReference': minimum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://hl7.eu/fhir/imaging-r4/StructureDefinition/im-composition-diagnosticReportReference']) &lt;= 1">extension with URL = 'http://hl7.eu/fhir/imaging-r4/StructureDefinition/im-composition-diagnosticReportReference': maximum cardinality of 'extension' is 1</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    ...
    <sch:rule context="f:Composition/f:identifier">
      ...
      <sch:assert test="count(f:extension[@url = 'http://hl7.org/fhir/5.0/StructureDefinition/extension-Composition.identifier']) &gt;= 1">extension with URL = 'http://hl7.org/fhir/5.0/StructureDefinition/extension-Composition.identifier': minimum cardinality of 'extension' is 1</sch:assert>
  ...
  <sch:pattern>
    <sch:title>f:Composition/f:event/f:detail/f:extension</sch:title>
    <sch:rule context="f:Composition/f:event/f:detail/f:extension">
      <sch:assert test="count(f:id) &lt;= 1">id: maximum cardinality of 'id' is 1</sch:assert>
  ...
  <sch:pattern>
    <sch:title>f:Composition/f:event/f:detail/f:extension/f:extension</sch:title>
    <sch:rule context="f:Composition/f:event/f:detail/f:extension/f:extension">
      <sch:assert test="count(f:id) &lt;= 1">id: maximum cardinality of 'id' is 1</sch:assert>
      <sch:assert test="count(f:url) &gt;= 1">url: minimum cardinality of 'url' is 1</sch:assert>
      <sch:assert test="count(f:url) &lt;= 1">url: maximum cardinality of 'url' is 1</sch:assert>
