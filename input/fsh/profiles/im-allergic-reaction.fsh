...
Description: "This profile represents a suspected allergic reaction occured during or due to an imaging study procedure."
* insert SetFmmAndStatusRule( 1, draft )
* insert MandateLanguageAndSecurity

* verificationStatus 0..1 MS
  * ^short = "Verification status of the allergic reaction"
  * ^definition = "The verification status to support the alleric origing of the observed reaction"
...
* reaction 0..* MS
  * extension contains $allergy-intollerance-certainty-url named allergyCertainty 0..1 MS
  * substance 0..1 MS
