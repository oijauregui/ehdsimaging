...
// * ^supportingInfo[pregnancy].extension contains CvServiceRequestSupportingInfoCodeableConcept named codeable-concept 0..*
// * ^supportingInfo[pregnancy].extension[codeable-concept].value[x] from http://hl7.org/fhir/uv/ips/ValueSet/pregnancy-status-uv-ips

// * supportingInfo[pregnancy] ^extension[CvServiceRequestSupportingInfoCodeableConcept][+].value[x] from http://hl7.org/fhir/uv/ips/ValueSet/pregnancy-status-uv-ips


* supportingInfo.extension contains CvServiceRequestSupportingInfoCodeableConcept named codeable-concept 0..*
* supportingInfo.extension[codeable-concept].value[x] from http://hl7.org/fhir/uv/ips/ValueSet/pregnancy-status-uv-ips

* extension contains CvServiceRequestReason named reason 0..*
