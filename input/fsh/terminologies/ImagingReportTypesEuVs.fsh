...
To add specificity the https://loinc.org/kb/users-guide/loinc-rsna-radiology-playbook-user-guide/ could be incorporated as the soruce of imaging study/report types."""
