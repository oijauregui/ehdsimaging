...
// TBD Add attachment to R4

* component
  * value[x] 1..1
  * value[x] only QuantityEu or RangeEu or CodeableConcept or string or integer or Ratio or SampledData or time or dateTime or Period
