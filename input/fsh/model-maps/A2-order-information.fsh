...
* group[+]
  ...
  * insert ElementMapping( #orderPlacerSpecialty, "A.2.5 Order placer speciality", #practitioner.practitioner.name, "", #equivalent )
...
//   * insert ElementMapping( #orderDateTime, "A.2.2 Order date and time", #authoredOn, "", #equivalent )
  ...
  * insert ElementMapping( #orderPlacerSpecialty, "A.2.5 Order placer speciality", #specialty, "", #equivalent )
