...
* group[+]
  ...
  * insert ElementMapping( #seriesEndpoint, "B.1.4.6 Series endpoint"                              , #endpoint, "when all series use the same endpoint.", #source-is-narrower-than-target )
  * insert ElementMapping( #seriesEndpoint, "B.1.4.6 Series endpoint"                              , #series.endpoint, "when the endpoint is specific for the series.", #equivalent )
...
* group[+]
  ...
  * insert ElementMapping( #radiationDoseInformation, "B.1.4.4 Radiation dose information" , #code, "Code the radiation dose.", #source-is-broader-than-target )
  * insert ElementMapping( #radiationDoseInformation, "B.1.4.4 Radiation dose information" , #valueQuantity, "Dose value.", #source-is-broader-than-target )
  // * insert ElementMapping( #otherSeriesInformation, "B.1.4.5 Other series information"             , #series.number, "", #equivalent )
  // * insert ElementMapping( #seriesNumber, "B.1.4.5.1 Series Number"                                , #series.number, "", #equivalent )
