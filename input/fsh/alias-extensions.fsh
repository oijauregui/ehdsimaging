...
Alias: $event-basedOn-url                     = http://hl7.org/fhir/StructureDefinition/event-basedOn|5.2.0-ballot
...
Alias: $note-url                              = http://hl7.org/fhir/StructureDefinition/note|5.2.0-ballot
