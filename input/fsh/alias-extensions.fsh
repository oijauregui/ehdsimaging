...
Alias: $artifact-version-url                  = http://hl7.org/fhir/StructureDefinition/artifact-version|5.2.0
...
Alias: $event-basedOn-url                     = http://hl7.org/fhir/StructureDefinition/event-basedOn|5.2.0
