...
// Alias: HumanName          = http://hl7.eu/fhir/base-r5/StructureDefinition/HumanName-eu
...
Alias: $EuImgLocation           = LocationImgEu
Alias: $EuImgLocationUrl        = http://hl7.eu/fhir/imaging-r5/StructureDefinition/LocationImgEu

// Alias: $EuLocation           = LocationEu
// Alias: $EuLocationUrl        = http://hl7.eu/fhir/imaging-r5/StructureDefinition/LocationEu
