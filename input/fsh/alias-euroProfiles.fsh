...
Alias: $EuAllergyIntoleranceUrl = http://hl7.eu/fhir/imaging-r4/StructureDefinition/AllergyIntoleranceEu
...
Alias: $EuBodyStructureUrl     = http://hl7.eu/fhir/imaging-r4/StructureDefinition/BodyStructureEu

Alias: $EuCondition            = ConditionEu
Alias: $EuConditionUrl         = http://hl7.eu/fhir/imaging-r4/StructureDefinition/ConditionEu

Alias: $EuCoverage             = Coverage
Alias: $EuCoverageUrl          = http://hl7.org/fhir/StructureDefinition/Coverage

Alias: $EuCarePlan             = CarePlanEu
Alias: $EuCarePlanUrl          = http://hl7.eu/fhir/imaging-r4/StructureDefinition/CarePlanEu
...
Alias: $EuEncounterUrl         = http://hl7.eu/fhir/imaging-r4/StructureDefinition/EncounterEu

Alias: $EuEndpoint             = EndpointEu
Alias: $EuEndpointUrl          = http://hl7.eu/fhir/imaging-r4/StructureDefinition/EndpointEu
...
Alias: $EuMedicationUrl        = http://hl7.eu/fhir/imaging-r4/StructureDefinition/MedicationEu

Alias: $EuObservation          = ObservationEu
Alias: $EuObservationUrl       = http://hl7.eu/fhir/imaging-r4/StructureDefinition/ObservationEu
...
Alias: $EuProcedureUrl         = http://hl7.eu/fhir/imaging-r4/StructureDefinition/ProcedureEu

Alias: $EuRange                = RangeEu
Alias: $EuRangeUrl             = http://hl7.eu/fhir/imaging-r4/StructureDefinition/RangeEu
...
Alias: $EuQuantityUrl          = http://hl7.eu/fhir/imaging-r4/StructureDefinition/QuantityEu

Alias: $EuSimpleQuantity       = SimpleQuantityEu
Alias: $EuSimpleQuantityUrl    = http://hl7.eu/fhir/imaging-r4/StructureDefinition/SimpleQuantityEu

Alias: $EuSpecimen             = SpecimenEu
Alias: $EuSpecimenUrl          = http://hl7.eu/fhir/imaging-r4/StructureDefinition/SpecimenEu
