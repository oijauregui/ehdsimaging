...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:ImagingStudy/f:series/f:instance">
      <sch:assert test="count(f:extension[@url = 'http://hl7.eu/fhir/imaging-r4/StructureDefinition/instance-description']) &lt;= 1">extension with URL = 'http://hl7.eu/fhir/imaging-r4/StructureDefinition/instance-description': maximum cardinality of 'extension' is 1</sch:assert>
    </sch:rule>
  </sch:pattern>
</sch:schema>
