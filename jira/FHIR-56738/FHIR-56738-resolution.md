...
|-------|-------|
| Key | FHIR-56738 |
| Title | §4 defines three data-format levels (minimal-metadata Collection bundle, section-structured Document bundle, fully-structured); the differentiation is unclear and the "metadata" vs "data" naming confuses |
| Type | Change Request |
| Status | Triaged |
| Reporter | JoshPriebe |
| Created | 4/30/26 |
