# Proposed Resolution for FHIR-56768
...
|-------|-------|
| Key | FHIR-56768 |
| Title | Editorial: report-profiles table focuses on images; should reference DiagnosticReport, Composition, etc. |
| Type | Change Request |
