...
|-------|-------|
| Key | FHIR-56740 |
| Title | informationRecipient on Composition is ambiguous; tie it to a specific clinical role (ordering provider, CC provider) rather than a generic recipient slot |
| Type | Change Request |
| Status | Triaged |
| Reporter | JoshPriebe |
| Created | 4/30/26 |
