...
|-------|-------|
| Key | FHIR-56733 |
| Title | ImagingStudy obligations on the Imaging Report Provider include image-level data (series, instances, endpoint) typically owned by the PACS / VNA. Soften. |
| Type | Change Request |
| Status | Triaged |
| Reporter | JoshPriebe |
| Created | 4/30/26 |
