...
|-------|-------|
| Key | FHIR-56721 |
| Title | Composition need not be signed by a single radiologist; allow Organization as attester.party; add guidance for legal authenticator and result validator |
| Type | Change Request |
| Status | Triaged |
| Reporter | JoshPriebe |
| Created | 4/30/26 |
