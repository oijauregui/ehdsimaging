...
|-------|-------|
| Key | FHIR-56722 |
| Title | The IG offers two paths to the same imaging report data (DocumentReference search and DiagnosticReport search); add guidance differentiating when to use each |
| Type | Change Request |
| Status | Triaged |
| Reporter | JoshPriebe |
| Created | 4/30/26 |
