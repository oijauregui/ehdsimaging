# Proposed Resolution for FHIR-56753
...
|-------|-------|
| Key | FHIR-56753 |
| Title | Identical elements (history / findings / comparison / recommendation) carry different obligations on DR vs Composition. Align or explain. |
| Type | Change Request |
| Status | Triaged |
| Reporter | JoshPriebe |
| Created | 4/30/26 |
