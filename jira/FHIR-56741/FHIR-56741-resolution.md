# Proposed Resolution for FHIR-56741
...
|-------|-------|
| Key | FHIR-56741 |
| Title | Imaging Report Provider is often downstream of the resulting system and may not have received discrete prior-comparison data; remove MS |
| Type | Change Request |
| Status | Triaged |
| Reporter | JoshPriebe |
| Created | 4/30/26 |
