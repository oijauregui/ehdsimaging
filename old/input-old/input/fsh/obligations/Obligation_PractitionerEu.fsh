...
////////////////////////////////////////////////////
Profile: ProducerObligationPractitionerEu
Parent: http://hl7.eu/fhir/base/StructureDefinition/practitioner-eu
Title: "Producer obligation for PractitionerEu"
Description: "Producer obligations for PractitionerEu"
* identifier
...
* name.family
  * ^extension[http://hl7.org/fhir/StructureDefinition/obligation][+].extension[code].valueCode = #SHALL:populate-if-known
  * ^extension[http://hl7.org/fhir/StructureDefinition/obligation][=].extension[actor].valueCanonical = Canonical(ImProvider)
* name.family.extension[fathersFamily]
  * ^extension[http://hl7.org/fhir/StructureDefinition/obligation][+].extension[code].valueCode = #SHALL:populate-if-known
  * ^extension[http://hl7.org/fhir/StructureDefinition/obligation][=].extension[actor].valueCanonical = Canonical(ImProvider)
* name.family.extension[mothersFamily]
  * ^extension[http://hl7.org/fhir/StructureDefinition/obligation][+].extension[code].valueCode = #SHALL:populate-if-known
  * ^extension[http://hl7.org/fhir/StructureDefinition/obligation][=].extension[actor].valueCanonical = Canonical(ImProvider)
* name.given
  * ^extension[http://hl7.org/fhir/StructureDefinition/obligation][+].extension[code].valueCode = #SHALL:populate-if-known
...
Profile: ConsumerObligationPractitionerEu
Parent: http://hl7.eu/fhir/base/StructureDefinition/practitioner-eu
Title: "Consumer obligation for PractitionerEu"
Description: "Consumer obligations for PractitionerEu"
* active
  * ^extension[http://hl7.org/fhir/StructureDefinition/obligation][+].extension[code].valueCode = #SHALL:handle-correctly
